        ...
        <div className="love-row reveal">
          <div className="love-rating">
            ...
            <div className="love-text">
              ...
              <small>Sur Google Reviews · 90+ bureaux d&apos;études vérifiés</small>
            </div>
          </div>
          ...
          <div className="love-clients">
            ...
            <div className="client-logos">
              <span className="client-logo">EnerAudit</span>
              <span className="client-logo">Thermika</span>
              <span className="client-logo">CEE Pro</span>
            </div>
          </div>
        </div>
      </div>

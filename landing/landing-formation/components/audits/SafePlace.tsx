      ...
      <div className="container">
        <div className="safe-grid">
          ...
          <div className="safe-text reveal delay-1">
            ...
            <p className="lead">
              Vos données sont hébergées en France. Vos attestations ont une valeur juridique légale. Notre veille
              réglementaire met votre CRM à jour dès qu&apos;une fiche d&apos;opération CEE évolue.
            </p>
            ...
            <div className="safe-features safe-features-grid">
              ...
              <div className="safe-feat">
                ...
                <div>
                  <strong>Attestations qualifiées</strong>
                  <span>Signature Certigna, valeur juridique opposable PNCEE.</span>
                </div>
              </div>
              <div className="safe-feat">
                <div className="safe-feat-icon">
                ...
                <div>
                  <strong>Veille CEE intégrée</strong>
                  <span>Mises à jour à chaque nouvelle version des fiches d&apos;opération.</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="safe-support safe-support--full reveal delay-2">
          ...
          <button
            ...
            onClick={() =>
              open({ source: 'audits-safe-place', ctaLabel: 'Discuter avec un expert betool' })
            }
          >
